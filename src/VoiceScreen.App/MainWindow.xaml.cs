...
public partial class MainWindow : Window
{
    ...
    private void OnLoaded(object sender, RoutedEventArgs e)
    {
        ...
        RemoteEnglishVoiceCombo.ItemsSource = new[] { string.IsNullOrWhiteSpace(_settings.RemoteEnglishVoice)
            ? "en_US-lessac-medium"
    ...
    private AppSettings ReadSettings()
    {
        return new AppSettings
        {
            ...
            RemoteEnglishVoice = RemoteEnglishVoiceCombo.SelectedItem as string
                                 ?? _settings.RemoteEnglishVoice,
    ...
    private async Task RefreshRemoteVoicesAsync(bool showErrors)
    {
        try
        {
            ...
            var previous = RemoteEnglishVoiceCombo.SelectedItem as string
                           ?? _settings.RemoteEnglishVoice;
            ...
            RemoteEnglishVoiceCombo.SelectedItem = voices.Contains(previous) ? previous : voices[0];
